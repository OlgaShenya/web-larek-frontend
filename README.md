...
ShopAPI обеспечивает обмен данными с сервером. AppState хранит данные и формирует события через брокер событий EventEmitter, обеспечивая связь модели с отображением
